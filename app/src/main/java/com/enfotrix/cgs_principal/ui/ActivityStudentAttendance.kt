...
class ActivityStudentAttendance : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getAttendence(Calendar.getInstance().get(Calendar.MONTH)+1)
        ...
        calendarView.setOnMonthChangedListener { widget, date ->
            ...
            getAttendence(currentMonth)
        }

    }

    @SuppressLint("SuspiciousIndentation")
    private fun getAttendence(month: Int) {
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                val result: QuerySnapshot = attendanceViewModel.getAttendence("01BDxMTFEqE0j1GJBTlf").await()
